    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            if(con !=null){
                ...
                st.executeUpdate("insert into contect (name,email,number)values('"+name.getText()+"','"+email.getText()+"','"+number.getText()+"')") ;
                JOptionPane.showMessageDialog(null,"submitted successfully") ;
            }
            else{
                JOptionPane.showMessageDialog(null,"submitation failed...") ;
            }
        }
        catch(Exception e){
            System.out.println(e);
